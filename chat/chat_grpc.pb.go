...
type ChatServiceClient interface {
	Post(ctx context.Context, in *Message, opts ...grpc.CallOption) (*PostResponse, error)
...
func (c *chatServiceClient) Post(ctx context.Context, in *Message, opts ...grpc.CallOption) (*PostResponse, error) {
	out := new(PostResponse)
	err := c.cc.Invoke(ctx, "/chat.ChatService/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	Post(context.Context, *Message) (*PostResponse, error)
...
func (UnimplementedChatServiceServer) Post(context.Context, *Message) (*PostResponse, error) {
...
func _ChatService_Post_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/Post",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).Post(ctx, req.(*Message))
	}
